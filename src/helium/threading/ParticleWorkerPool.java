...
public final class ParticleWorkerPool {
    ...
    public static void init(int threads) {
        ...
        initialized = true;
        HeliumClient.LOGGER.info("particle pool initialized with {} threads", (Object)threadCount);
    }
        ...
        for (int c = 0; c < chunks; ++c) {
            ...
            executor.submit(() -> {
                try {
                    ...
                    HeliumClient.LOGGER.error("particle worker error", (Throwable)e);
                }
                finally {
                    latch.countDown();
                }
    ...
    @FunctionalInterface
    @Environment(value=EnvType.CLIENT)
    public static interface ParticleTask<T> {
        public void process(T var1, int var2);
    }
}
